    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = "INSERT INTO `tsf_task1`.`transfer`(`sender`, `receiver`, `amount`, `email`,`d/t`) VALUES ('$sender', '$receiver', '$amount', current_timestamp());";
...
?>
    ...
    <footer class="end">
        <p> The Spark Bank | Made By Intern - Pranjal Srivastava | ALL RIGHT RESERVED</p>
    </footer>
